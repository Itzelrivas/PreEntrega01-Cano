...
do{
    ...
    if(pregunta == 2015){
        let porcentaje = (numIntentos - 1)*5 + 15
        alert(`¡Muchas felicidades! Utiliza el código de descuento ${nombre.toUpperCase()}paciente${porcentaje} para obtener el ${porcentaje}% de descuento en tu próximo tratamiento.`)
    }
